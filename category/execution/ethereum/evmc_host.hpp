...
struct EvmcHost final : public EvmcHostBase
{
        ...
        Address const &from, Address const &to, uint256_t const &value)
    {
        ...
        // unlike geth, which puts it at index 0 and shifts every later logIndex
        // out of line with the receipt; second means filtering 0xeeee... leaves
        // exactly the sequence a real block produces.
