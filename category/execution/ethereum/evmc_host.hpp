...
struct EvmcHost final : public EvmcHostBase
{
        ...
        Address const &from, Address const &to, uint256_t const &value)
    {
        ...
        // a different account. One predicate serves both log kinds below, and
        // most messages carry no value, so this exit is the common path.
        ...
        // eth_simulate's ERC-7528 synthetic, kept alongside the consensus log
        // and emitted first: geth's observed order for calls and creates (its
        // SELFDESTRUCT differs), not specified anywhere.
