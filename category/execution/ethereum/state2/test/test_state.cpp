...
TYPED_TEST(InMemoryStateTraitsTest, selfdestruct_merge_commit_incarnation)
{
    ...
    {
        auto [released_state, released_code, _, access_] =
            std::move(bs).release();
        commit_simple(
            this->tdb,
            *released_state,
...
TYPED_TEST(OnDiskCachedTestSuite, undecided_proposals)
{
    ...
    auto
        [released_state_111,
         ...
         _released_access_111] = std::move(bs_111).release();
    commit_simple(
        db,
        *released_state_111,
        released_code_111,
    ...
    auto
        [released_state_121,
         ...
         _released_access_121] = std::move(bs_121).release();
    commit_simple(
        db,
        *released_state_121,
        released_code_121,
    ...
    auto
        [released_state_112,
         ...
         _released_access_112] = std::move(bs_112).release();
    commit_simple(
        db,
        *released_state_112,
        released_code_112,
    ...
    auto
        [released_state_122,
         ...
         _released_access_122] = std::move(bs_122).release();
    commit_simple(
        db,
        *released_state_122,
        released_code_122,
    ...
    auto
        [released_state_131,
         ...
         _released_access_131] = std::move(bs_131).release();
    commit_simple(
        db,
        *released_state_131,
        released_code_131,
    ...
    auto
        [released_state_132,
         ...
         _released_access_132] = std::move(bs_132).release();
    commit_simple(
        db,
        *released_state_132,
        released_code_132,
...
TEST_F(InMemoryStateTest, merge_access_sets)
{
    ...
    EXPECT_TRUE(access.at(a).contains(key1));
