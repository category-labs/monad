...
TYPED_TEST(InMemoryStateTraitsTest, selfdestruct_merge_commit_incarnation)
{
    ...
    {
        auto [released_state, released_code, _, _candidates] =
            std::move(bs).release();
        commit_simple(
            this->tdb,
            *released_state,
    ...
    InMemoryStateTraitsTest, self_destruct_storage_reads_capture_first_destruct)
{
    ...
    auto [_state, _code, self_destruct_reads, _candidates] =
        std::move(bs).release();
...
TYPED_TEST(OnDiskCachedTestSuite, proposal_basics)
{
    ...
    auto
        [released_state1,
         ...
         _released_candidates1] = std::move(bs1).release();
    commit_simple(
        db,
        *released_state1,
        released_code1,
    ...
    auto
        [released_state2,
         ...
         _released_candidates2] = std::move(bs2).release();
    commit_simple(
        db,
        *released_state2,
        released_code2,
...
TYPED_TEST(OnDiskCachedTestSuite, undecided_proposals)
{
    ...
    auto
        [released_state_111,
         ...
         _released_candidates_111] = std::move(bs_111).release();
    commit_simple(
        db,
        *released_state_111,
        released_code_111,
    ...
    auto
        [released_state_121,
         ...
         _released_candidates_121] = std::move(bs_121).release();
    commit_simple(
        db,
        *released_state_121,
        released_code_121,
    ...
    auto
        [released_state_112,
         ...
         _released_candidates_112] = std::move(bs_112).release();
    commit_simple(
        db,
        *released_state_112,
        released_code_112,
    ...
    auto
        [released_state_122,
         ...
         _released_candidates_122] = std::move(bs_122).release();
    commit_simple(
        db,
        *released_state_122,
        released_code_122,
    ...
    auto
        [released_state_131,
         ...
         _released_candidates_131] = std::move(bs_131).release();
    commit_simple(
        db,
        *released_state_131,
        released_code_131,
    ...
    auto
        [released_state_132,
         ...
         _released_candidates_132] = std::move(bs_132).release();
    commit_simple(
        db,
        *released_state_132,
        released_code_132,
...
namespace
{
    ...
    private:
            ...
            std::optional<uint64_t> const parent)
        {
            ...
            bs2.merge(st2);
            {
                auto [state1, code1, _, _c1] = std::move(bs1).release();
                commit_simple(
                    db1_,
                    *state1,
                    code1,
            ...
            {
                auto [state2, code2, _, _c2] = std::move(bs2).release();
                commit_simple(
                    db2_,
                    *state2,
                    code2,
