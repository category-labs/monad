...
// No TraitsTest instantiation activates EIP-7708 (AMSTERDAM is above
// LATEST_SUPPORTED_EVM_FORK, MONAD_NEXT above the MonadTraits matrix), so the
// branches above never run. Pin a fixture. Removable once that bumps.
template <typename T>
