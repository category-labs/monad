...
TEST(PrestateTracer, pre_state_to_json)
{
    ...
    as.prestate_storage_.insert(key1, value1);
    as.prestate_storage_.insert(key2, value2);
    as.prestate_storage_.insert(key3, value3);
...
TEST(PrestateTracer, geth_example_prestate)
{
    ...
    OriginalAccountState as{a};
    as.prestate_storage_.insert(key4, value4);
    as.prestate_storage_.insert(key5, value5);
    as.prestate_storage_.insert(key6, value6);
    as.prestate_storage_.insert(key7, value7);
