...
static_assert(sizeof(MonadConsensusBlockHeaderV0) == 856);
static_assert(alignof(MonadConsensusBlockHeaderV0) == 8);

static_assert(sizeof(MonadConsensusBlockHeaderV1) == 816);
static_assert(alignof(MonadConsensusBlockHeaderV1) == 8);

static_assert(sizeof(MonadConsensusBlockHeaderV2) == 840);
...
static_assert(sizeof(MonadConsensusBlockV0) == 928);
static_assert(alignof(MonadConsensusBlockV0) == 8);

static_assert(sizeof(MonadConsensusBlockV1) == 888);
static_assert(alignof(MonadConsensusBlockV1) == 8);

static_assert(sizeof(MonadConsensusBlockV2) == 912);
