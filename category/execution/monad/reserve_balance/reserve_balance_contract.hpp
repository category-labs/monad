...
inline constexpr uint256_t DEFAULT_RESERVE_BALANCE_WEI =
    10 * uint256_t{1'000'000'000'000'000'000};
inline constexpr uint64_t DELAY_BLOCKS = 3; // k
...
public:
    ...
    Result<byte_string>
    precompile_update(byte_string_view, Address const &, uint256_be_t const &);
