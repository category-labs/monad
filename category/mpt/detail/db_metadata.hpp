...
namespace detail
{
    ...
    struct db_metadata
    {
        ...
        */
        ...
        // Intent log for crash-safe ring shrink/grow. Stamped + msync'd
        // before any ring write; cleared + msync'd after the (idempotent)
        // body completes. On open, a nonzero op_kind triggers replay.
        ...
        uint8_t future_variables_unused
            [4040 - sizeof(root_offsets_ring_t) - 2 * sizeof(timeline_state_t) -
             8 - 8 - sizeof(pending_shrink_grow_t)];
