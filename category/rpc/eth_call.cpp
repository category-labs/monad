...
struct Pool
{
    ...
    Pool(Type type, pool_config const &config)
        : type(type)
...
struct monad_eth_call_executor
{
    ...
    monad_eth_call_executor(
        pool_config const &low_pool_config, pool_config const &high_pool_config,
...
monad_eth_call_executor *monad_eth_call_executor_create(
    pool_config const low_pool_conf, pool_config const high_pool_conf,
