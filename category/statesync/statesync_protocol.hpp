...
{
    explicit StatesyncProtocolV1(uint32_t const version)
        : version_{version}
    {
    }
...
struct StatesyncProtocolPagePassthrough : StatesyncProtocolV1
{
    using StatesyncProtocolV1::StatesyncProtocolV1;
