...
namespace monad::vm::fuzzing
{
    ...
    Result discrete_choice(Engine &eng, Default &&d, Choices &&...choices)
    {
        ...
        auto dist = std::uniform_real_distribution<double>(0.0, 1.0); // NOLINT(misc-auto-const-correctness)
    ...
    auto const &uniform_sample(Engine &eng, Iterator begin, Iterator end)
    {
        ...
        auto dist = std::uniform_int_distribution<diff_t>(0, end - begin - 1); // NOLINT(misc-auto-const-correctness)
