...
struct EvmcHost : public evmc::Host
{
    ...
    {
        return state_.set_storage(Address(a), key, value);
    }

    virtual uint256be get_balance(address_t const &a) const noexcept override
    {
        return state_.get_balance(Address(a));
    }
    ...
    {
        return state_.get_code_hash(Address(a));
    }
    ...
    {
        return state_.selfdestruct(Address(a), Address(beneficiary));
    }
    ...
    {
        return state_.access_account(Address(a));
    }

    virtual evmc_access_status
    access_storage(address_t const &a, bytes32_t const &key) noexcept override
    {
        return state_.access_storage(Address(a), key);
    }
};
