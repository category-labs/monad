...
struct EVMOneBaselineInterpreter
{
    ...
    evmc_result execute(TState const &s, TEvmHost *h, evmc_message const &m)
    {
        auto const code =
        ...
        evmone::ExecutionState es{
            m, TTraits::rev, *reinterpret_cast<evmc_host_interface *>(h), nullptr, byte_string_view{code}, {}};
        evmone::baseline::CodeAnalysis ca{
            evmone::baseline::analyze(TTraits::rev, byte_string_view{code})};
