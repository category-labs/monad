...
/// Options needed to connect to the monad process
...
/// Connect to a monad execution process with the provided options
...
/// Import the shared memory segments for an event ring into this process
...
/// and this is called once to initialize that state at set the initial
/// iteration point
...
struct monad_event_imported_ring
{
    ...
    size_t true_fragment_table_size;     ///< Table size + overwrite (for Rust)
