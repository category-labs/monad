...
TEST(Rlp_Block, DecodeEncodeBlock46402)
{
    ...
    auto const block = block_db.read_block(46'402);
    ...
    EXPECT_EQ(
        block.value().header.beneficiary,
        0x01434e4Ac3238bEC44a39ad642aBaBBB68D097e6_address);
    EXPECT_EQ(
        block.value().header.state_root,
    ...
    EXPECT_EQ(
        block.value().header.receipts_root,
    ...
    byte_string_fixed<256> const bloom{
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00};
    EXPECT_EQ(block.value().header.logs_bloom, bloom);
    EXPECT_EQ(block.value().header.difficulty, 1467524208078);
    EXPECT_EQ(block.value().header.number, 46402);
    EXPECT_EQ(block.value().header.gas_limit, 24404);
    EXPECT_EQ(block.value().header.gas_used, 24000);
    EXPECT_EQ(block.value().header.timestamp, 1438922535);
    EXPECT_EQ(
        block.value().header.extra_data,
    ...
    EXPECT_EQ(
        block.value().header.prev_randao,
        0xf8808df56cbe52ae9c97985e824da926fd05505266960c37a516219f85c131d4_bytes32);
    EXPECT_EQ(
        block.value().header.nonce,
        byte_string_fixed<8UL>(
            {0xbc, 0xfd, 0x19, 0x03, 0x4f, 0xda, 0x04, 0x90}));

    EXPECT_EQ(block.value().transactions.size(), 1);

    EXPECT_EQ(block.value().transactions[0].type, TransactionType::legacy);
    EXPECT_EQ(block.value().transactions[0].nonce, 3);
    EXPECT_EQ(block.value().transactions[0].max_fee_per_gas, 10000000000000);
    EXPECT_EQ(block.value().transactions[0].gas_limit, 24000);
    EXPECT_EQ(block.value().transactions[0].to, std::nullopt);
    EXPECT_EQ(block.value().transactions[0].value, 0);
    EXPECT_EQ(block.value().transactions[0].sc.chain_id, std::nullopt);
    EXPECT_EQ(
        block.value().transactions[0].sc.r,
        0x589b4531c6d66f6850277af29e06e60b28a280916ccbb38595bf3347aca65c2c_u256);
    EXPECT_EQ(
        block.value().transactions[0].sc.s,
        0x40b1a3d6e47a04c0cd78506aa7d3aa0aeef734d7942424abdb64c88c2ba5f536_u256);

    EXPECT_EQ(block.value().ommers.size(), 0);

    // check encoding
    auto const encoded_block = rlp::encode_block(block.value());
...
{
    BrotliBlockDb const block_db(test_resource::correct_block_data_dir);
    auto const block = block_db.read_block(2'730'000);
    ...
    byte_string_fixed<256> const bloom{
        ...
        0x00, 0x00, 0x00, 0x00};
    EXPECT_EQ(block.value().header.logs_bloom, bloom);
    EXPECT_EQ(block.value().header.difficulty, 71133750415151);
    EXPECT_EQ(block.value().header.number, 2730000);
    EXPECT_EQ(block.value().header.gas_limit, 3293766);
    EXPECT_EQ(block.value().header.gas_used, 84000);
    EXPECT_EQ(block.value().header.timestamp, 1480625618);
    EXPECT_EQ(
        block.value().header.extra_data,
        byte_string(
            {0x65,
    ...
    EXPECT_EQ(block.value().transactions.size(), 4);

    EXPECT_EQ(block.value().transactions[0].type, TransactionType::legacy);
    EXPECT_EQ(block.value().transactions[0].nonce, 1639528);
    EXPECT_EQ(block.value().transactions[0].max_fee_per_gas, 25000000000);
    EXPECT_EQ(block.value().transactions[0].gas_limit, 90000);
    EXPECT_EQ(
        *block.value().transactions[0].to,
        0xBB474EdbC0C6ecF5c0455F8e6F90b8D46098e016_address);
    EXPECT_EQ(block.value().transactions[0].value, 0x3dd59a7fca63400_u256);
    EXPECT_EQ(block.value().transactions[0].sc.chain_id, 0x01);
    EXPECT_EQ(
        block.value().transactions[0].sc.r,
    ...
    EXPECT_EQ(block.value().transactions[1].type, TransactionType::legacy);
    EXPECT_EQ(block.value().transactions[1].nonce, 886728);
    EXPECT_EQ(block.value().transactions[1].max_fee_per_gas, 20000000000);
    EXPECT_EQ(block.value().transactions[1].gas_limit, 90000);
    EXPECT_EQ(
        *block.value().transactions[1].to,
        0x288E49EDb33A4B88860e8ce10A0407eaefd7dfdA_address);
    EXPECT_EQ(block.value().transactions[1].value, 0x6ef6dd445b94970_u256);
    EXPECT_EQ(block.value().transactions[1].sc.chain_id, 0x1);
    EXPECT_EQ(
        block.value().transactions[1].sc.r,
        0x928ab5ed683df54e59ef2a849bf83b4ee2f49e232e4a2a3d411594ce6377287c_u256);
    EXPECT_EQ(
        block.value().transactions[1].sc.s,
        0x6b332e891a4f5b051f49016a79cfbac771061153af9660697d900325bcebef51_u256);

    EXPECT_EQ(block.value().transactions[2].type, TransactionType::legacy);
    EXPECT_EQ(block.value().transactions[2].nonce, 1639529);
    EXPECT_EQ(block.value().transactions[2].max_fee_per_gas, 25000000000);
    EXPECT_EQ(block.value().transactions[2].gas_limit, 90000);
    EXPECT_EQ(
        *block.value().transactions[2].to,
        0xA7895d323bFc62E82dE69D208E5d1670708588eB_address);
    EXPECT_EQ(block.value().transactions[2].value, 0x3d3c2fc0caddc00_u256);
    EXPECT_EQ(block.value().transactions[2].sc.chain_id, 0x01);
    EXPECT_EQ(
        block.value().transactions[2].sc.r,
        0x7b86ce1ec9f35571228f085bd4f9ef4a5f69b52bb3dbf3c5fdf20d3a636deba_u256);
    EXPECT_EQ(
        block.value().transactions[2].sc.s,
        0x2ef365b24554adad7514ae5337c669c59a9c2affdb5663aa96850cc2efd0df89_u256);

    EXPECT_EQ(block.value().transactions[3].type, TransactionType::legacy);
    EXPECT_EQ(block.value().transactions[3].nonce, 886729);
    EXPECT_EQ(block.value().transactions[3].max_fee_per_gas, 20000000000);
    EXPECT_EQ(block.value().transactions[3].gas_limit, 90000);
    EXPECT_EQ(
        *block.value().transactions[3].to,
        0x31Cca7cc41128aeFCD0E35D9bdeBAdC75bF7CA27_address);
    EXPECT_EQ(block.value().transactions[3].value, 0xdee6c72f83b7184_u256);
    EXPECT_EQ(block.value().transactions[3].sc.chain_id, 0x01);
    EXPECT_EQ(
        block.value().transactions[3].sc.r,
        0xab34ebfd6c27049f4cd3246c75adb7d6798a085153cdb917388e76c61ba599ab_u256);
    EXPECT_EQ(
        block.value().transactions[3].sc.s,
...
{
    BrotliBlockDb const block_db(test_resource::correct_block_data_dir);
    auto const block = block_db.read_block(2'730'001);
    EXPECT_TRUE(block.has_value());
    ...
    EXPECT_EQ(block.value().header.difficulty, 71064317416445);
    EXPECT_EQ(block.value().header.number, 2730001);
    EXPECT_EQ(block.value().header.gas_limit, 3296981);
    EXPECT_EQ(block.value().header.gas_used, 196834);
    EXPECT_EQ(block.value().header.timestamp, 1480625657);
    EXPECT_EQ(
        block.value().header.extra_data,
        byte_string(
            {0x65,
    ...
    EXPECT_EQ(block.value().transactions.size(), 7);

    EXPECT_EQ(block.value().transactions[0].type, TransactionType::legacy);
    EXPECT_EQ(block.value().transactions[0].nonce, 1639530);
    EXPECT_EQ(block.value().transactions[0].max_fee_per_gas, 25000000000);
    EXPECT_EQ(block.value().transactions[0].gas_limit, 90000);
    EXPECT_EQ(
        *block.value().transactions[0].to,
        0x92A4bc572595ed4851E0AbF8fF72a77bBa9323C0_address);
    EXPECT_EQ(block.value().transactions[0].value, 0x3b7e74a7f3af400_u256);
    EXPECT_EQ(block.value().transactions[0].sc.chain_id, 0x01);
    EXPECT_EQ(
        block.value().transactions[0].sc.r,
    ...
    EXPECT_EQ(block.value().transactions[1].type, TransactionType::legacy);
    EXPECT_EQ(block.value().transactions[1].nonce, 21);
    EXPECT_EQ(block.value().transactions[1].max_fee_per_gas, 20000000000);
    EXPECT_EQ(block.value().transactions[1].gas_limit, 300000);
    EXPECT_EQ(
        *block.value().transactions[1].to,
        0x65C28345d499b59606cFe3d0ed580a1d2370C7C9_address);
    EXPECT_EQ(block.value().transactions[1].value, 0);
    EXPECT_EQ(
        block.value().transactions[1].sc.chain_id,
    ...
    EXPECT_EQ(block.value().transactions[2].type, TransactionType::legacy);
    EXPECT_EQ(block.value().transactions[2].nonce, 92940);
    EXPECT_EQ(block.value().transactions[2].max_fee_per_gas, 20000000000);
    EXPECT_EQ(block.value().transactions[2].gas_limit, 39000);
    EXPECT_EQ(
        *block.value().transactions[2].to,
        0xeDc53fB256c8F5cd6f91AF675BBb89bFC3732c57_address);
    EXPECT_EQ(block.value().transactions[2].value, 0xe7f24b03527b860_u256);
    EXPECT_EQ(block.value().transactions[2].sc.chain_id, 0x01);
    EXPECT_EQ(
        block.value().transactions[2].sc.r,
    ...
    EXPECT_EQ(block.value().transactions[3].type, TransactionType::legacy);
    EXPECT_EQ(block.value().transactions[3].nonce, 886730);
    EXPECT_EQ(block.value().transactions[3].max_fee_per_gas, 20000000000);
    EXPECT_EQ(block.value().transactions[3].gas_limit, 90000);
    EXPECT_EQ(
        *block.value().transactions[3].to,
        0x33BE3ADC19fD04a21bEd5d55DC1FD1F9Df5439E1_address);
    EXPECT_EQ(block.value().transactions[3].value, 0xe282b737fa1986c_u256);
    EXPECT_EQ(block.value().transactions[3].sc.chain_id, 0x01);
    EXPECT_EQ(
        block.value().transactions[3].sc.r,
    ...
    EXPECT_EQ(block.value().transactions[4].type, TransactionType::legacy);
    EXPECT_EQ(block.value().transactions[4].nonce, 1639531);
    EXPECT_EQ(block.value().transactions[4].max_fee_per_gas, 25000000000);
    EXPECT_EQ(block.value().transactions[4].gas_limit, 90000);
    EXPECT_EQ(
        *block.value().transactions[4].to,
        0x57a5809cb4ED2e40630f5A0F26273dc08A9a92cd_address);
    EXPECT_EQ(block.value().transactions[4].value, 0x39473f637aa0800_u256);
    EXPECT_EQ(block.value().transactions[4].sc.chain_id, 0x01);
    EXPECT_EQ(
        block.value().transactions[4].sc.r,
        0x98753c57dc147ca4fba5eb4038d03fb7751dd5c940e22e1774e8d22db5b22169_u256);
    EXPECT_EQ(
        block.value().transactions[4].sc.s,
        0x7317951a0f0b2cd45647407b2b9c87fc89d311ff03913d2c2f42041c15d634a5_u256);

    EXPECT_EQ(block.value().transactions[5].type, TransactionType::legacy);
    EXPECT_EQ(block.value().transactions[5].nonce, 1639532);
    EXPECT_EQ(block.value().transactions[5].max_fee_per_gas, 25000000000);
    EXPECT_EQ(block.value().transactions[5].gas_limit, 90000);
    EXPECT_EQ(
        *block.value().transactions[5].to,
        0x009fAC3897c8Acbc0AE6e2a92Bc0755AA9E91DCc_address);
    EXPECT_EQ(block.value().transactions[5].value, 0x3907052df885000_u256);
    EXPECT_EQ(block.value().transactions[5].sc.chain_id, 0x01);
    EXPECT_EQ(
        block.value().transactions[5].sc.r,
        0xf4d94f88f029f3b64b280dbd034fdfce92f048166b85d95d21ea82913c4b428b_u256);
    EXPECT_EQ(
        block.value().transactions[5].sc.s,
        0x46c6acae965e6c8fe44785a8461b430b34c0983542aaf11a8d22de5add2f6bb2_u256);

    EXPECT_EQ(block.value().transactions[6].type, TransactionType::legacy);
    EXPECT_EQ(block.value().transactions[6].nonce, 1639533);
    EXPECT_EQ(block.value().transactions[6].max_fee_per_gas, 25000000000);
    EXPECT_EQ(block.value().transactions[6].gas_limit, 90000);
    EXPECT_EQ(
        *block.value().transactions[6].to,
        0x54Ee2a8B5C61a45749E89471C75d45d3159D6947_address);
    EXPECT_EQ(block.value().transactions[6].value, 0x38ebe0341834c00_u256);
    EXPECT_EQ(block.value().transactions[6].sc.chain_id, 0x01);
    EXPECT_EQ(
        block.value().transactions[6].sc.r,
        0x93fd750d39fbab2ad14865d77438556f4a7c17225cfdb423c9ec07db6790253c_u256);
    EXPECT_EQ(
        block.value().transactions[6].sc.s,
    ...
    ASSERT_FALSE(decoded_block.has_error());
    EXPECT_EQ(encoded_block_view.size(), 0);
    EXPECT_EQ(decoded_block.value(), block.value());
}

TEST(Rlp_Block, DecodeEncodeBlock2730002)
{
    BrotliBlockDb const block_db(test_resource::correct_block_data_dir);
    auto const block = block_db.read_block(2'730'002);
    EXPECT_TRUE(block.has_value());
    ...
    EXPECT_EQ(
        block.value().header.receipts_root,
        0x56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421_bytes32);
    EXPECT_EQ(block.value().header.difficulty, 71029651597139);
    EXPECT_EQ(block.value().header.number, 2730002);
    EXPECT_EQ(block.value().header.gas_limit, 3294051);
    EXPECT_EQ(block.value().header.gas_used, 0);
    EXPECT_EQ(block.value().header.timestamp, 1480625678);
    EXPECT_EQ(
        block.value().header.extra_data,
        byte_string(
            {0xe4,
    ...
    EXPECT_EQ(block.value().transactions.size(), 0);
...
{
    BrotliBlockDb const block_db(test_resource::correct_block_data_dir);
    auto const block = block_db.read_block(2730009);
    EXPECT_TRUE(block.has_value());
    ...
    EXPECT_EQ(
        block.value().header.receipts_root,
        0x56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421_bytes32);
    EXPECT_EQ(block.value().header.difficulty, 71168718072168);
    EXPECT_EQ(block.value().header.number, 2730009);
    EXPECT_EQ(block.value().header.gas_limit, 3300000);
    EXPECT_EQ(block.value().header.gas_used, 0);
    EXPECT_EQ(block.value().header.timestamp, 1480625740);
    EXPECT_EQ(
        block.value().header.extra_data,
...
{
    BrotliBlockDb const block_db(test_resource::correct_block_data_dir);
    auto const block = block_db.read_block(14'000'000);
    EXPECT_TRUE(block.has_value());
    ...
    byte_string_fixed<256> const bloom{
        ...
        0x50, 0x00, 0xc1, 0xe1};
    EXPECT_EQ(block.value().header.logs_bloom, bloom);
    EXPECT_EQ(block.value().header.difficulty, 12316581093827601);
    EXPECT_EQ(block.value().header.number, 14000000);
    EXPECT_EQ(block.value().header.gas_limit, 30058561);
    EXPECT_EQ(block.value().header.gas_used, 8119826);
    EXPECT_EQ(block.value().header.timestamp, 1642114795);
    ...
    EXPECT_EQ(block.value().transactions.size(), 112);

    EXPECT_EQ(block.value().transactions[0].type, TransactionType::eip1559);
    EXPECT_EQ(block.value().transactions[0].nonce, 2760);
    EXPECT_EQ(
        block.value().transactions[0].max_priority_fee_per_gas, 8540000000);
    EXPECT_EQ(block.value().transactions[0].max_fee_per_gas, 291900000000);
    EXPECT_EQ(block.value().transactions[0].gas_limit, 1395940);
    EXPECT_EQ(
        *block.value().transactions[0].to,
        0x9008d19f58aabd9ed0d60971565aa8510560ab41_address);
    EXPECT_EQ(block.value().transactions[0].value, 0);
    EXPECT_EQ(block.value().transactions[0].access_list.size(), 0);
    ...
    EXPECT_EQ(block.value().transactions[1].type, TransactionType::legacy);
    EXPECT_EQ(block.value().transactions[1].nonce, 947217);
    EXPECT_EQ(block.value().transactions[1].max_fee_per_gas, 230000000000);
    EXPECT_EQ(block.value().transactions[1].gas_limit, 207128);
    EXPECT_EQ(
        *block.value().transactions[1].to,
        0x95ad61b0a150d79219dcf64e1e6cc01f0b64c4ce_address);
    EXPECT_EQ(block.value().transactions[1].value, 0);

    EXPECT_EQ(*block.value().transactions[1].sc.chain_id, 0x01);
    EXPECT_EQ(
        block.value().transactions[1].sc.r,
