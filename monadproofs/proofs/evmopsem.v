...
Record AccountM : Type :=
  {
    ...
    lastDelUndelInBlockIndex : option N; (* last block index where this address was delegated or undelegated or some code was deployed or undeployed at this address using CREATE(2): get back to the latter point *)
