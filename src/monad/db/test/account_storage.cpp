...
TEST(AccountStorage, can_merge_added)
{
    store_t db{};
    AccountStorage s{db};
...
TEST(AccountStorage, can_merge_deleted)
{
    store_t db{};
    db[a].insert({key2, value2});
    AccountStorage s{db};
...
TEST(AccountStorage, can_merge_modified)
{
    store_t db{};
    db[a].insert({key1, value1});
    AccountStorage s{db};
...
TEST(AccountStorage, can_merge_modify_merged_added)
{
    store_t db{};
    AccountStorage s{db};
...
TEST(AccountStorage, can_merge_delete_merged_added)
{
    store_t db{};
    AccountStorage s{db};
...
TEST(AccountStorage, can_merge_add_on_merged_deleted)
{
    store_t db{};
    db[a].insert({key2, value2});
    AccountStorage s{db};
...
TEST(AccountStorage, can_merge_delete_merged_modified)
{
    store_t db{};
    db[a].insert({key1, value1});
    AccountStorage s{db};
...
TEST(AccountStorage, cant_merge_colliding_merge)
{
    store_t db{};
    db[a].insert({key1, value1});
    AccountStorage s{db};
...
TEST(AccountStorage, cant_merge_delete_conflicts_with_modify)
{
    store_t db{};
    db[a].insert({key1, value1});
    AccountStorage s{db};
...
TEST(AccountStorage, merge_touched_multiple)
{
    store_t db{};
    db[a].insert({key1, value1});
    db[b].insert({key1, value1});
