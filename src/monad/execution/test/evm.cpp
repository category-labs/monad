...
TEST(Evm, create_contract_account)
{
    ...
    fake::Interpreter::_result = {
        .status_code = EVMC_SUCCESS, .gas_left = 8'000};
...
TEST(Evm, revert_create_account)
{
    ...
    fake::Interpreter::_result = {
        .status_code = EVMC_REVERT, .gas_left = 11'000};
...
TEST(Evm, call_evm)
{
    ...
    fake::Interpreter::_result = {
        .status_code = EVMC_SUCCESS, .gas_left = 7'000};
...
TEST(Evm, revert_call_evm)
{
    ...
    fake::Interpreter::_result = {.status_code = EVMC_REVERT, .gas_left = 6'000};
