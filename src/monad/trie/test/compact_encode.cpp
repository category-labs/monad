...
{
    auto path = Nibbles(
        byte_string{0x01, 0x02, 0x03, 0x04, 0x05}, Nibbles::FromNibbleArray{});
    ...
    path = Nibbles(
        byte_string({0x00, 0x01, 0x02, 0x03, 0x04, 0x05}),
    ...
    path = Nibbles(
        byte_string{0x00, 0x0f, 0x01, 0x0c, 0x0b, 0x08},
        Nibbles::FromNibbleArray{});
    ...
    path = Nibbles(
        byte_string({0x0f, 0x01, 0x0c, 0x0b, 0x08}),
        Nibbles::FromNibbleArray{});
