...
inline std::unordered_map<
    ...
    revision_map = {
        ...
        {"Osaka", MONAD_ETH_OSAKA},               {"BPO1", MONAD_ETH_OSAKA},
        {"BPO2", MONAD_ETH_OSAKA},                {"OsakaToBPO1AtTime15k", MONAD_ETH_OSAKA},
        {"BPO1ToBPO2AtTime15k", MONAD_ETH_OSAKA}, {"Amsterdam", MONAD_ETH_AMSTERDAM},
