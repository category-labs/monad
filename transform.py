...
def merge(s_2, s_3):
    ...
    if s_2.path == common_prefix:
        ...
        return Branch(s_2.path, s_2.branches + [s_3.path[len(common_prefix)]])
    
    return Branch(common_prefix, [s_2.path[len(common_prefix)],
                                  s_3.path[len(common_prefix)]])
...
def main():
    ...
    assert(transform(None                    , Leaf("1234"), Leaf("1235"), None)         == Branch("123", ["4", "5"]))
    assert(transform(Branch("12", ["1", "2"]), Leaf("1234"), Leaf("1235"), None)         == Branch("123", ["4", "5"]))
    assert(transform(None                    , Leaf("1234"), Leaf("1235"), Leaf("1237")) == Branch("123", ["4", "5"]))
    assert(transform(Branch("12", ["1", "2"]), Leaf("1234"), Leaf("1235"), Leaf("1237")) == Branch("123", ["4", "5"]))
    ...
    assert(transform(None, Branch("123", ["1", "2"]), Leaf("1235"), Leaf("1236")) == Branch("123", ["1", "2", "5"]))
    assert(transform(Branch("12", ["1", "2"]), Branch("123", ["1", "2"]), Leaf("1235"), Leaf("1236")) == Branch("123", ["1", "2", "5"]))
    assert(transform(Branch("12", ["1", "2"]), Branch("123", ["1", "2"]), Branch("1235", ["1", "2"]), Leaf("1236")) == Branch("123", ["1", "2", "5"]))

    # emitting new branch
    assert(transform(None, Branch("123", ["1", "2"]), Branch("124", ["1", "2"]), None) == Branch("12", ["3", "4"]))
    assert(transform(Branch("1", ["1", "2"]), Branch("123", ["1", "2"]), Branch("124", ["1", "2"]), None) == Branch("12", ["3", "4"]))
    assert(transform(None, Branch("123", ["1", "2"]), Branch("124", ["1", "2"]), Leaf("1256")) == Branch("12", ["3", "4"]))
