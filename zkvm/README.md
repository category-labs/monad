...
Guest for executing Ethereum witnesses inside a zero-knowledge VM.
...
│   ├── execute_witness.cpp # monad_zkvm_execute_witness
...
[`zkvm_io.h`](../third_party/zkevm-standards/standards/io-interface/zkvm_io.h). On ZisK the guest is a Rust crate and those
