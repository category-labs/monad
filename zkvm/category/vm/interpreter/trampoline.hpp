...
// zkVM mirror: the trampoline is implemented inline with setjmp/longjmp
// instead of via the host's hand-rolled assembly (entry.S). The jmp_buf
// lives on the caller's stack frame thanks to always_inline; longjmp
// from monad::vm::runtime::exit lands back here and we return.
