...
// zkVM shadow of category/vm/runtime/keccak.hpp. The host uses
// ethash::keccak256 for the SHA3 opcode; we route to the per-zkVM
// keccak256(in, len, out) via the shared shadow at
// zkvm/category/core/keccak.h (forwards to zkvm_keccak256).
