 ...
 *   does may not see a difference between the sizes needed for the EVM and
 *   the sizes needed here.
 *
 * Usage Notes:
 ...
 * @param data Pointer to input data
 * @param len Length of input data in bytes
 * @param[out] output Pointer to output hash (20 bytes of hash, first 12 bytes
 * zero-padded)
 * @return ZKVM_EOK on success, ZKVM_EFAIL on failure
 */
zkvm_status
