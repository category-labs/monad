...
//
// We link against libzkevm.a — built from the SP1 zkEVM SDK source at build
// time (see zkvm/build-support) — which
...
// `read_input` and commits the roots with one `write_output` a value.
//
