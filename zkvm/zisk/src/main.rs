...
// standard interface (third_party/zkevm-standards io-interface/zkvm_io.h):
// it calls read_input to fetch the RLP-encoded witness and write_output to
// emit the 32-byte block hash.
